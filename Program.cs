...
namespace Caso_notas
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            double Proyecto_F = Validar_nota("Ingresar nota del proyecto final: ");
            double Lab = Validar_nota("Ingresar nota de laboratorio: ");
            //validando
            while (true)
            {
            ...
            Console.WriteLine("Condicion: " + condicion_Estudiante);
            Console.WriteLine("================================");
            Console.ReadKey();
        }
    }   
